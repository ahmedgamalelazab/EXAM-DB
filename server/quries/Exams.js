...
module.exports.insertExam = async function (exam_name, duration, total_marks, instructor_id) {
    let exam_name_checked = typeof exam_name === 'string' ? exam_name : null;
    let duration_checked = typeof duration === 'number' ? duration : null;
    let total_marks_checked = typeof total_marks === 'number' ? total_marks : null;
    let instructor_id_checked = typeof instructor_id === 'string' ? instructor_id : null;
    
    if (exam_name_checked === null || duration_checked === null ||
        total_marks_checked === null || instructor_id_checked === null) {
...
module.exports.updateExam = async function (id, exam_name, duration, total_marks, instructor_id) {
    ...
    if (id_checked === null || exam_name_checked === null ||
        duration_checked === null || total_marks_checked === null ||
